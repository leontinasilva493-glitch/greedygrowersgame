...
const ROUTE_LAST_MODIFIED = new Map<string, Date>([
  ...
  ["/guides/miracle-grow", new Date("2026-09-05T00:00:00.000Z")],
  ["/guides/farmers-market", new Date("2026-08-29T00:00:00.000Z")],
  ["/guides/seed-feeding-chair", new Date("2026-08-29T00:00:00.000Z")],
  ["/pets/majestic-egg", new Date("2026-08-30T00:00:00.000Z")],
  ["/official-links", new Date("2026-08-30T00:00:00.000Z")],
  ["/guides/weather-events", new Date("2026-08-30T00:00:00.000Z")],
]);
const ROUTES = [
  "/",
  "/about",
